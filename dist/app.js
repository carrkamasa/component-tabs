...
jQuery(document).ready(function ($) {
    ...
    if ($('.page-builder-tabs').length > 0) {
        var initialTab = document.querySelector('[data-content]');
        var initialTabHeight = document.querySelector('[data-content]').scrollHeight;
    ...
    window.onresize = function (event) {
        var activeTabHeight = document.querySelector('.tabs__content.active').scrollHeight;
    ...
    $('[data-tab]').on('click', function (event) {
        ...
        $(event.currentTarget).addClass('active').siblings('[data-tab]').removeClass('active');

        var tabNew = $(event.currentTarget).parent().siblings().children('[data-content=' + $(event.currentTarget).data('tab') + ']');
        var tabNewHeight = tabNew[0].scrollHeight;
        ...
        $(event.currentTarget).parent().siblings().children('[data-content=' + $(event.currentTarget).data('tab') + ']').addClass('active').siblings('[data-content]').removeClass('active');
